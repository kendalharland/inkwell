...
// Landing-page screenshot rotator: crossfade through every <img>
// inside .screenshot-rotator every ROTATE_MS. Assumes the first
// <img> starts with the `active` class (matching the markup in
// docs/index.md). No-op when the container isn't present or holds
// only one image.
(function () {
  var ROTATE_MS = 4000;
